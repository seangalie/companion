...
- Kept App Store and macOS update credential prompts visible by surfacing them inside the TUI and falling back to the foreground terminal in plain CLI mode.
