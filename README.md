...
- In the TUI, commands that prompt for credentials open a full-screen foreground overlay with the prompt and recent command output so the request stays visible. In plain CLI mode, those commands use the foreground terminal.
